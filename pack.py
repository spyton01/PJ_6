...
button_minus = Button(root, text="-", padx=39, pady=20, command=button_subtract)
button_multiply = Button(root, text="*", padx=39, pady=20, command=button_time)
button_divide = Button(root, text="/", padx=39, pady=20, command=button_dvide)
